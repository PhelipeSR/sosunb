function add_demand(data, selector){
	...
	<div class="row justify-content-center mt-4">
		<div class="col-lg-8 col-xl-6 border py-3 shadow-sm">
			...
			<div class="media d-flex align-items-center mt-2 bg-light rounded ">
				<img class="img-fluid mr-3 ml-1 radius-50" style="max-width: 50px" src="<?php echo base_url('uploads/perfil/default.png')?>">
				<div class="media-body">
					<span class="text-primary">Phelipe Sousa Resende</span>
					<p class="text-muted">publicou</p>
				</div>
				<span class="float-right">
					<a class="dropdown-item text-danger" href="#"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
				</span>
			</div>
