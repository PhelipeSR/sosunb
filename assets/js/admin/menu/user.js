...
$(document).ready(function() {
	...
	$(document).off('click', '.excluir').on('click', '.excluir', function(){
		...
		$.ajax({
			url: base_url('admin/menu/user/delete_user'),
			method: 'post',
			dataType: 'json',
			data: {
				id: id,
	...
	$(document).off('click', '.editar').on('click', '.editar', function(){
		...
		var row = user_table.row( $('[data-row="'+$(this).data('btn')+'"]') ).data();
		$('#id').val(row.id);
	...
	*  ===================================================================== */
	...
	$( "#formAddUser" ).validate( {
		...
		submitHandler: function (form) {
			$.ajax({
				url: base_url('admin/menu/user/create_user'),
				method: 'post',
				dataType: 'json',
	...
	$( "#formEditUser" ).validate( {
		...
		submitHandler: function (form) {
			$.ajax({
				url: base_url('admin/menu/user/update_user'),
				method: 'post',
				dataType: 'json',
